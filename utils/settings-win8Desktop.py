...
class Settings:
    ...
    LTspice_components_directory: str = 'circuit_simulation/ltspice_local/spice/components/'
    LTspice_required_directory: str = LTspice_components_directory + 'requiredSubCells'
    ...
    LTspice_avail_activation_fn = ['column_activ_cmos', 'column_activ_comparator', 
                                   'column_activ_relu', 'column_activ_tia_relu', 'column_activ_cmos_v2', 'column_activ_cmos_v3']
