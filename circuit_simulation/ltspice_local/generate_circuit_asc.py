...
import sys, getopt
import circuit_simulation.ltspice_local.nn_layer as nn_lyr
...
def create_directory(overwrite: bool = False):
     ...
     shutil.copyfile(config.LTspice_components_directory + 'simulation_parameters.txt', config.LTspice_data_directory + '/simulation_parameters.txt')
