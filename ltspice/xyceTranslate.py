...
def translate_netlist2xyce(input_file_name: str = "data/ltspice_tmp_files/simulation_results/complete_circuit_generated.net"):
    ...
    print(f'Translate: File Size is {os.stat(input_file_name).st_size / (1024 * 1024)} MB')
    ...
    print(f'Translate: Number of Lines in the input file is {count}')
    print(f'Translate: Number of Lines copied to XYCE is {count_out}')
